...
export default function DriverCard() {
  ...
  return (
    <div className="relative order-first lg:order-last">
      <div
        ref={cardRef}
        className="bg-white rounded-2xl shadow-2xl p-4 sm:p-6 transform rotate-3 hover:rotate-0 transition-transform duration-300 border border-orange-100 max-w-sm mx-auto lg:max-w-none hover:shadow-3xl"
      >
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center space-x-3">
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary-100 rounded-full flex items-center justify-center">
          <SteeringWheel className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600" />
        </div>
        <div>
      ...
      {stats.map((stat, index) => (
        ...
        >
          ...
          <div className="flex items-center">
            {stat.icon && (
              <stat.icon className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-400 fill-current" />
            )}
            <span
  ...
  return (
    <div className="bg-primary-50 rounded-lg p-3 border border-orange-100">
      <div className="flex items-center text-orange-700">
        <MapPin className="status-indicator w-3 h-3 sm:w-4 sm:h-4 mr-2" />
