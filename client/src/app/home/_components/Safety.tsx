...
export default function Safety() {
  ...
  return (
    <section
      ref={sectionRef}
      id="safety"
      className="relative flex items-center pt-14 md:pt-20 pb-14 md:pb-24 bg-primary-dark min-h-[70dvh]"
    >
      <div className="absolute inset-0 bg-primary-dark bg-[url(/images/road-pattern.png)] bg-blend-multiply" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="safety-header text-center mb-8 md:mb-16">
          <h2 className="text-[36px] md:text-5xl text-foreground font-medium font-dm-serif-display mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div ref={cardRef} className="bg-foreground rounded-2xl p-8">
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-2 text-background">
                Emergency Hotline
              </h3>
              <p className="text-sm md:text-base text-background mb-6">
              ...
              <div className="space-y-4">
                <Button size="large" shape="round" className="w-full">
                  ...
                  Call Emergency
                  <span className="hidden lg:inline">: (555) 911-SAFE</span>
                </Button>
                <Button
                  size="large"
                  type="outlined"
                ...
                >
                  ...
                  Regular Booking
                  <span className="hidden lg:inline">: (555) 123-RIDE</span>
                </Button>
              </div>
            </div>
          </div>
